...
{
    public partial class Level3Round2Form : Form
    {
        ...
        private void Level3Round2Form_Load(object sender, EventArgs e)
        {
        ...
        private void GetQuestion()
        {
            ...
            if (unattemptQuestions.Count() > 0)
            {
                ...
                {
                    pictureBoxTheme.ImageLocation = startupPath + "" + question.DocUrl;
                }
        ...
        private void Level3Round2Form_FormClosing(object sender, FormClosingEventArgs e)
        {
            Program.chooseLevelForm.Text = "Choose quiz level and round";
