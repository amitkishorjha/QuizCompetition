...
{
    public partial class Level2Round3Form : Form
    {
        ...
        private void Level2Round3Form_Load(object sender, EventArgs e)
        {
            WrongtextBox.Text = "0";
            CorrecttextBox.Text = "0";
        ...
        private void Level2Round3Form_FormClosing(object sender, FormClosingEventArgs e)
        {
            Program.chooseLevelForm.Text = "Choose quiz level and round";
