...
{
    public partial class Level2Round2Form : Form
    {
        ...
        private void Level2Round2Form_Load(object sender, EventArgs e)
        {
        ...
        private void GetQuestion()
        {
            ...
            if (unattemptQuestions.Count() > 0)
            {
                ...
                if (question.DocUrl != "")
                {
                    if (question.DocUrl.Split(',').Length > 0)
                    {
                        pictureBoxOp1.ImageLocation = startupPath + "" + question.DocUrl.Split(',')[0];
                        pictureBoxOp2.ImageLocation = startupPath + "" + question.DocUrl.Split(',')[1];
                        pictureBoxOp3.ImageLocation = startupPath + "" + question.DocUrl.Split(',')[2];
                        pictureBoxOp4.ImageLocation = startupPath + "" + question.DocUrl.Split(',')[3];
                    }
                }
                CalculateMarks();
        ...
        {
            MessageBox.Show(CorrectAnswerlabel.Text);
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (IsDisable == true && Round.Split(',')[0] != "tie Breaker")
            {
                ...
                Program.Round = "Round3," + _quizRoundService.GetAll().Where(x => x.Name == "Round3").Select(x => x.Id).FirstOrDefault().ToString();
        ...
        private void ShowAnswerbtn_Click_1(object sender, EventArgs e)
        {
            MessageBox.Show(CorrectAnswerlabel.Text);
        }
        ...
        private void Level2Round2Form_FormClosing(object sender, FormClosingEventArgs e)
        {
            Program.chooseLevelForm.Text = "Choose quiz level and round";
