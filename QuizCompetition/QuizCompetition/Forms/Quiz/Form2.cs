...
namespace QuizCompetition.Forms.Quiz
{
    public partial class Form2 : Form
    {
        ...
        private void GetQuestion()
        {
            ...
            var attempted = _attamtedQuestionsService.GetAll().Where(x => x.AcademicYear == Program.CurrAcademicYear).ToList();

            var questions = _quizQuestionService.GetAll().Where(x => x.LevelId == LevelId && x.RoundId == RoundId
                           && x.AcademicYear == Program.CurrAcademicYear).ToList();
            ...
            if (unattemptQuestions.Count() > 0)
            {
                ...
                Op1label.Text = question.Option1;
                Op2label.Text = question.Option2;
                Op3label.Text = question.Option3;
                Op4label.Text = question.Option4;
        ...
        {
            if (CorrectAnswerlabel.Text == Op1label.Text)
            {
                panel4.BackColor = Color.YellowGreen;
            }
            else if (CorrectAnswerlabel.Text == Op2label.Text)
            {
                panel6.BackColor = Color.YellowGreen;
            }
            else if (CorrectAnswerlabel.Text == Op3label.Text)
            {
                panel5.BackColor = Color.YellowGreen;
            }
            else if (CorrectAnswerlabel.Text == Op4label.Text)
            {
                panel7.BackColor = Color.YellowGreen;
            }

            if (CorrectAnswerlabel.Text == Userselectionlabel.Text)
            {
            ...
            {
                if (Userselectionlabel.Text == Op1label.Text)
                {
                    panel4.BackColor = Color.Red;
                }
                else if (Userselectionlabel.Text == Op2label.Text)
                {
                    panel6.BackColor = Color.Red;
                }
                else if (Userselectionlabel.Text == Op3label.Text)
                {
                    panel5.BackColor = Color.Red;
                }
                else if (Userselectionlabel.Text == Op4label.Text)
                {
        ...
        private void Rightbtn_Click(object sender, EventArgs e)
        {
            ...
            if (checkforattamt.Count() == 0)
            {
                ...
                attamtedQuestions.QuestionId = questionnid;
                attamtedQuestions.LevelId = LevelId;
                attamtedQuestions.RoundId = RoundId;
        ...
        {
            panel4.BackColor = Color.FromArgb(255, 191, 0);
            panel6.BackColor = Color.GhostWhite;
            panel5.BackColor = Color.GhostWhite;
            panel7.BackColor = Color.GhostWhite;

            Userselectionlabel.Text = Op1label.Text;
        }

        private void panel6_MouseClick(object sender, MouseEventArgs e)
        {
            panel6.BackColor = Color.FromArgb(255, 191, 0);
            panel4.BackColor = Color.GhostWhite;
            panel5.BackColor = Color.GhostWhite;
            panel7.BackColor = Color.GhostWhite;

            Userselectionlabel.Text = Op2label.Text;

        }

        private void panel5_MouseClick(object sender, MouseEventArgs e)
        {
            panel5.BackColor = Color.FromArgb(255, 191, 0);
            panel4.BackColor = Color.GhostWhite;
            panel6.BackColor = Color.GhostWhite;
            panel7.BackColor = Color.GhostWhite;

            Userselectionlabel.Text = Op3label.Text;
        }

        private void panel7_MouseClick(object sender, MouseEventArgs e)
        {
            panel7.BackColor = Color.FromArgb(255, 191, 0);
            panel4.BackColor = Color.GhostWhite;
            panel5.BackColor = Color.GhostWhite;
            panel6.BackColor = Color.GhostWhite;

            Userselectionlabel.Text = Op4label.Text;
        }
        ...
        private void panel6_MouseClick_1(object sender, MouseEventArgs e)
        {
            ...
            CorrectAnslabel.Text = Op2label.Text;
            Userselectionlabel.Text = Op2label.Text;
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                button2.Enabled = false;
                // MessageBox.Show(Level.Split(',')[0] + " " + Round.Split(',')[0] + " finished , Please go to next round", "Alert");
                ...
                Program.Round = "Round2," + _quizRoundService.GetAll().Where(x => x.Name == "Round2").Select(x => x.Id).FirstOrDefault().ToString();

                if (Level.Split(',')[0] == "Level1")
                {
                    Level1Round2Form Question = new Level1Round2Form();
                    Question.Text = "Question";
                    Question.Show();
                }
                else if (Level.Split(',')[0] == "Level2")
                {
                    Level2Round2Form Question = new Level2Round2Form();
                    Question.Text = "Question";
                    Question.Show();
                }
                else if (Level.Split(',')[0] == "Level3")
                {
